...
This option opens the "Open 3D Tiff file or 2D Tiff stack " dialog (see Fig. \ref{open_tiff} \pageref{open_tiff}). Data type and dimensions are automatically detected, but you have to fill index order and voxel size.
