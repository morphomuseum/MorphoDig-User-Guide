...
In the example presented Fig. \ref{export_curves} p. \pageref{export_curves}, 5 segments have been digitized, and the default number of landmarks per segment is 60, but the user has chosen to export segments 2 and 4 using 20 equidistant landmarks instead.
