...
\begin{figure}
  \centering  
 \includegraphics[scale=0.35]{images/08/ssao.png}
 \captionof{figure}{Surface rendering of a cranium of \textit{Homo sapiens}. \textbf{Left-} SSAO turned off \textbf{Right- } SSAO rendering activated. Keep in mind that transparent screenshots do not work using SSAO rendering.}
\label{ssao_example}
\end{figure}